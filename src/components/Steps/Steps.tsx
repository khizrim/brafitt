      ...
      <div className="steps__container">
        ...
        <ul className="steps__list">
          ...
          <li className="steps__item">
            ...
            />
            <p className="steps__text">
              Проанализирует, правильно ли оно подобрано и расскажет,
              как улучшить посадку и исправить ошибки.
            </p>
          </li>
          <li className="steps__item">
            ...
            <p className="steps__text">
              ...
              в перчатках и маске, а измерительная лента будет
              продезинфицирована.
            </p>
          </li>
          <li className="steps__item">
            ...
            />
            <p className="steps__text">
              В 90% случаев размер приходится менять. Брафиттер укажет
              ваш точный размер и расскажет, на что обращать внимание
              при выборе.
            </p>
          </li>
          <li className="steps__item">
